...
class Freecanser_service_opt2 extends Widget_Base {

	public function get_name() {
        return 'Freecanser_service_opt2';
    }

	public function get_title() {
        return __( 'Freecanser service Opt 2', 'freecanser-toolkit' );
    }
                    ...
                    <div class="container">
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-6 col-md-12 content">
                                ...
                                <h2><?php echo esc_html($settings['service_opt2_title']); ?></h2>
                                <p><?php echo esc_html($settings['service_opt2_content']); ?></p>
                                <p><?php echo esc_html($settings['service_opt2_content2']); ?></p>
                            ...
                            <div class="col-lg-6 col-md-12 image">
                                <img src="<?php echo esc_url($settings['service_opt2_img']['url']); ?>" alt="<?php echo esc_attr($settings['title']); ?>">
                            </div>
...
Plugin::instance()->widgets_manager->register( new Freecanser_service_opt2 );